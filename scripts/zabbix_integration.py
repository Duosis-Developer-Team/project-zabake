...
# 2) Input JSON verisini dosyadan okuyoruz. Argüman olarak dosya yolu verilmeli.
if len(sys.argv) < 2:
    raise Exception("Lütfen JSON input dosya yolunu belirtin.")
...
try:
    ...
    raise Exception(f"Dosya okunurken hata oluştu veya JSON formatı hatalı: {e}")
