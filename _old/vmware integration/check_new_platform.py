...
# API bilgileri
api_url = "https://loki.bulutistan.com/api/dcim/platforms/?limit=1000"
...
# new_records değişkeni, tabloda bulunmayan ve eklenen kayıtları içerir.
print("Yeni Kayıtlar (JSON formatında):")
